          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Katılın ve Verimliliğinizi Artırın!
              </h2>
              <p>
                Bizimle birlikte adım atın ve işletmenizin verimliliğini artırmak için hazır çözüm ürünlerimizi keşfedin. Hemen başlayın ve farkı hissedin!
              </p>
            </motion.div>
            <motion.div
              variants={{
